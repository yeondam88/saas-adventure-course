<div class="w-full lg:max-w-full lg:flex py-4">
    <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden"
        style="background-image: url('https://source.unsplash.com/random')" title="Woman holding a mug">
    </div>
    <div
        ...
        <div class="mb-8">
            ...
            <div class="text-gray-900 font-bold text-xl mb-2">{{ $course->name }}</div>
            <p class="text-gray-700 text-base">{{ $course->headline }}</p>
