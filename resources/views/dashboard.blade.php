				...
				<ul class="relative">
					<li class="activeLink">
						<a href=""
							...
							<span
								class="ml-3 text-sm font-medium transition-all ease-out transition-medium text-gray-700">
								Home
							</span>
						</a>
					</li>
					...
					<li>
						<a href=""
							...
							<span
								class="ml-2 text-sm font-medium transition-all ease-out transition-medium text-gray-700">
								Analytics
							</span>
						</a>
					</li>
