...
<div>
    ...
    <div class="bg-gray-200 md:overflow-hidden pt-8">
        <div class="px-4 pt-32 pb-8">
            <div class="relative w-full md:max-w-2xl md:mx-auto text-center">
                <h1 class="font-bold text-gray-700 text-xl sm:text-2xl md:text-5xl leading-tight mb-6">
                    A simple and smart platform that will help developers
                </h1>
                ...
                <div class="hidden md:block h-40 w-40 rounded-full bg-blue-800 absolute right-0 bottom-0 -mb-64 -mr-48">
                </div>
                            ...
                            <div class="rounded-lg shadow px-2 py-2">
                                ...
                                <div class="mb-2">
                                    <svg height="50" width="50" viewBox="0 0 20 20" class="mx-auto">
                                        ...
                                        <circle r="5" cx="10" cy="10" fill="transparent" stroke="#eee" stroke-width="10"
                                            stroke-dasharray="11 31.4" transform="rotate(-90) translate(-20)" />
                                    </svg>
                                </div>
    ...
    <p class="text-center p-4 text-gray-600 mt-10">
        Created by
        <a class="border-b text-blue-500" href="https://twitter.com/mithicher" target="_blank">@mithicher</a>.
        Inspired
        by dribble shot
