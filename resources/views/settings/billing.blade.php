      ...
      <div class="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
        ...
        <div class="md:w-2/3 w-full">
          <div class="py-8 px-16">
            ...
            <input class="mt-2 border-2 border-gray-200 px-3 py-2 block w-full rounded-lg text-base text-gray-900 focus:outline-none focus:border-indigo-500" id="card-holder-name" type="text" name="card-holder-name">
          </div>
